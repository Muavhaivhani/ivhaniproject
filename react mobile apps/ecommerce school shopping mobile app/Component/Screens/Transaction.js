...
import status from './../../assets/image/Carttranscation.png';
...
function Transaction({ navigation }) {
    ...
    return (<View style={styles.container}>
        ...
        <View style={{
            ...
            marginLeft: Dimensions.get('window').width * 0.300
        }}>
            <Text style={{ fontSize: 20, color: "#2980b9" }}>Transaction History</Text>
        </View>
        <View style={{
            backgroundColor: "#2980b9",
